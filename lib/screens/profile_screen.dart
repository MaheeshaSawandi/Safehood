...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> loadEmergencyContacts() async {
    ...
    setState(() {
      contact1Name = prefs.getString("ec1_name") ?? "Spouse";
      contact1Phone = prefs.getString("ec1_phone") ?? "+94 77 123 4567";
      contact2Name = prefs.getString("ec2_name") ?? "Home Address";
      contact2Phone =
          prefs.getString("ec2_phone") ?? "123, Lotus Road, Colombo 07";
    });
  }
  ...
  Future<void> saveEmergencyContacts() async {
    ...
    await prefs.setString("ec1_name", contact1Name);
    await prefs.setString("ec1_phone", contact1Phone);
    await prefs.setString("ec2_name", contact2Name);
    await prefs.setString("ec2_phone", contact2Phone);
