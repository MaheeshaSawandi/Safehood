...
class _AlertScreenState extends State<AlertScreen> {
  ...
  // ============================================
  // SAVE ALERT DATA TO SUPABASE
  // ============================================

  Future<void> saveAlertsToSupabase() async {
    ...
    try {
      ...
      debugPrint(
        "Crime alerts inserted successfully"
      );
